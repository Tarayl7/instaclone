...
class EllipsisModal extends React.Component {
  ...
  render() {
    return (
      <Modal
        isOpen={this.props.ellipsisModalIsOpen}
        onRequestClose={this.props.closeEllipsisModal}
        style={{
          overlay: {
      ...
      >
        <div>
          {this.props.currentPageOn === "profile-page" ? (
            <div>
              <div
                className="ellipsis-modal-delete-post"
                onClick={this.props.deletePost}
              >
                Delete Post
              </div>
              <div
                className="ellipsis-modal-cancel"
                onClick={this.props.closeEllipsisModal}
              >
                Cancel
              </div>
            </div>
            ...
            <div>
              <div
                className="ellipsis-modal-navigate"
                onClick={this.props.navigateToUserPage(this.props.postUserId)}
              >
                Go to posts
              </div>
              <div
            ...
            <div>
              <div className="ellipsis-modal-text" onClick={this.changeLikes}>
                {this.state.text}
              </div>
              <div
                className="ellipsis-modal-cancel"
...
export default connect(mapStateToProps, null)(EllipsisModal);

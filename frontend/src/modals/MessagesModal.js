...
class MessagesModal extends React.Component {
  ...
  addUser = () => {
    ...
    const usernamesOfRecipients = this.props.messages.map(
      (user) => user.recipientUsername
    );
    ...
    this.props.updateMessagesPage(
      this.state.clickedUserId,
      this.state.clickedUserProfilePic,
  ...
  render() {
    ...
    return (
      <Modal
        isOpen={this.props.messagesModalIsOpen}
      ...
      >
        <div>
          <div className="messages-modal-top">
            ...
            <div>New Message</div>
            <div>
              <button className="messages-modal-button" onClick={this.addUser}>
                Next
              </button>
            </div>
          </div>
            ...
            <form className="messages-modal-form">
              {this.state.clickedUserUsername === "" ? (
                ...
                <div className="messages-modal-falsy-div">
                  <label className="messages-modal-label">To: </label>
                  <span className="messages-modal-span">
                    {this.state.clickedUserUsername}
                  </span>
                  <input
                    className="messages-modal-input"
          ...
          <div className="messages-modal-filtered-users">{filteredUsers}</div>
        </div>
      </Modal>
    );
  }
...
export default connect(mapStateToProps, null)(MessagesModal);

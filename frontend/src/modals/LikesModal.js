...
class LikesModal extends React.Component {
    ...
    toggle = (userId, userUsername, userFullName, userProfilePic) => {
        ...
        const toggleLikesArray = this.props.toggleLikesArray.map(user => {
    ...
    render() {
        ...
        const likes = this.props.toggleLikesArray.map((user, index) => {
            return(
                <div key={index}>
                    <LayoutOfUsers 
                        user={user}
        ...
        return(
            <Modal isOpen={this.props.likesModalIsOpen} onRequestClose={this.props.closeLikesModal} style={{
                overlay: {
                ...
                <div>
                    <div className='likes-modal-top'>Likes</div>
                    {likes}
                </div>
            </Modal>
        )
...
const mapStateToProps = state => {
    return {
        ...
        toggleLikesArray: state.user.toggleLikesArray,

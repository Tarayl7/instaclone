...
class Edit extends React.Component {
    ...
    updateProfilePic = async (e) => {
        ...
        if (this.state.editedProfilePic !== '') {
            ...
            axios.put('user/update_profilePic_of_arrays/' + this.props.loggedInUserUsername, {
                profilePic: this.state.editedProfilePic
            })
        ...
        this.props.updateProfilePicAndPublicId(this.state.editedProfilePic, this.state.publicId)
    ...
    deleteProfilePic = (e) => {
        ...
        if (this.props.loggedInUserProfilePic !== 'https://res.cloudinary.com/t-eason/image/upload/v1602544214/n4mdsqo5puulsacc9nuq.jpg') {
            axios.post('delete/image', { public_id: this.props.loggedInUserPublicId })
        }

        axios.patch('user/update_profilePic/' + this.props.loggedInUserId, {
            profilePic: 'https://res.cloudinary.com/t-eason/image/upload/v1602544214/n4mdsqo5puulsacc9nuq.jpg',
            publicId: ''
        })
        ...
        this.props.updateProfilePic('https://res.cloudinary.com/t-eason/image/upload/v1602544214/n4mdsqo5puulsacc9nuq.jpg');
    ...
    onChange = (e) => {
        ...
        } else if (e.currentTarget.name === 'edit-bio' && e.currentTarget.value.length <= 150) {
    ...
    handleSubmit = (e) => {
        ...
        if (this.state.editedUsername !== '' || this.state.editedFullName !== '') {
            axios.put('user/update_user_info/' + this.props.loggedInUserId, {
            ...
            if (this.state.errorMsg === '') {
                ...
                axios.put('user/update_names_of_arrays/' + this.props.loggedInUserUsername, {
                    username: this.state.editedUsername,
                    fullName: this.state.editedFullName
                })
                ...
                this.props.updateUsernameFullNameAndBio(this.state.editedUsername, this.state.editedFullName, this.state.editedBio);
            }
        }
    };
            ...
            <div>
                ...
                <div className='edit-container'>
                    ...
                    <div className='edit-top'>
                        <div>
                            <img className='edit-profile-pic' src={this.props.loggedInUserProfilePic} alt='' onClick={this.editModal} />
                        </div>
                        <div className='edit-username-and-text-div'>
                            <p className='edit-username'>{this.props.loggedInUserUsername}</p>
                            <p className='edit-text' onClick={this.editModal}>Change Profile Picture</p>
                        </div>
                    </div>
                    <form className='edit-form' onSubmit={this.handleSubmit}>
                        <div className='edit-label-and-input-div'>
                            <label className='edit-input-label'>username</label>
                            <input className='edit-input' onChange={this.onChange} value={this.state.editedUsername} name='edit-username' placeholder=' required' /><br />
                        </div>
                        <div className='edit-label-and-input-div'>
                            <label className='edit-input-label'>fullName</label>
                            <input className='edit-input' onChange={this.onChange} value={this.state.editedFullName} name='edit-fullName' placeholder=' required' /><br />
                        </div>
                        <div className='edit-label-and-input-div'>
                            <label className='edit-textarea-label'>Bio</label>
                            <textarea className='edit-textarea' onChange={this.onChange} value={this.state.editedBio} name='edit-bio' /><br />
                        </div>
...
const mapDispatchToProps = dispatch => {
    return {
        updateProfilePicAndPublicId: (pic, publicId) => dispatch(updateProfilePicAndPublicId(pic, publicId)),
        updateProfilePic: pic => dispatch(updateProfilePic(pic)),
        updateUsernameFullNameAndBio: (username, fullName, bio) => dispatch(updateUsernameFullNameAndBio(username, fullName, bio))
    }
}

...
class UserProfilePage extends React.Component {
  ...
  componentDidUpdate = async () => {
    ...
    if (
      this.props.navbarUserSelected === true ||
  ...
  openFollowersModal = async () => {
    ...
    const toggleFollowersArray = this.props.profileUserFollowersArray.map(
      (user) => {
  ...
  openFollowingModal = async () => {
    ...
    const toggleFollowingArray = this.props.profileUserFollowingArray.map(
      (user) => {
        if (this.props.loggedInUserUsername === user.username) {
          user.display = "none";
    ...
    const profileUserPosts = this.props.profileUserPosts.map((post, index) => {
      return (
        <div key={index}>
          {post.type === "image" ? (
            <img
              className="user-profile-page-post-image"
              src={post.url}
              alt=""
            ...
            post.type === "video" && (
              <video
                className="user-profile-page-post-video"
                src={post.url}
                onClick={this.openPostModal.bind(this, post._id)}
              />
            )
      ...
      <div>
        ...
        <div className="user-profile-page-container">
          <div className="user-profile-page-top">
            <div>
              <img
                className="user-profile-page-profile-pic"
                src={this.props.profileUserProfilePic}
                alt=""
              />
            </div>
            <div>
              <div className="user-profile-page-username-and-button-div">
                <div>
                  <p className="user-profile-page-username">
                    {this.props.profileUserUsername}
                  </p>
                </div>
                <div className="user-profile-page-button-div">
                  <button
                    className="user-profile-page-message-button"
                    onClick={() => navigate("/messages")}
                  >
                    Message
                  </button>
                  <button
                    className="user-profile-page-toggle-button"
                    onClick={this.toggle}
                    style={{
              ...
              <div className="user-profile-page-posts-followers-and-following-div">
                <p className="user-profile-page-posts">
                  <span className="user-profile-page-posts-span">
                    {this.props.profileUserPosts.length}
                  </span>{" "}
                  posts
                </p>
                <p
                  className="user-profile-page-followers"
                  onClick={this.openFollowersModal}
                >
                  <span className="user-profile-page-followers-span">
                    {this.props.profileUserFollowersArray.length}
                  </span>{" "}
                  followers
                </p>
                <p
                  className="user-profile-page-following"
                  onClick={this.openFollowingModal}
                >
                  <span className="user-profile-page-following-span">
                    {this.props.profileUserFollowingArray.length}
                  </span>{" "}
                  following
                </p>
              </div>
              <div className="user-profile-page-full-name-div">
                <p className="user-profile-page-full-name">
                  {this.props.profileUserFullName}
                </p>
              </div>
              <div className="user-profile-page-bio-div">
                <p className="user-profile-page-bio">
                  {this.props.profileUserBio}
                </p>
              </div>
            </div>
          </div>
          <div className="user-profile-page-posts-div">{profileUserPosts}</div>
        </div>
        <FollowersModal
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    setNavbarUserSelectedToFalse: () =>
      dispatch(setNavbarUserSelectedToFalse()),
    setProfileUserChangedToFalse: () =>
      dispatch(setProfileUserChangedToFalse()),
  };
};

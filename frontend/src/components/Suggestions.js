...
class Suggestions extends React.Component {
  ...
  componentDidMount = async () => {
    ...
    let usernamesOfFollowingArray = this.props.loggedInUserFollowingArray.map(
      (user) => {
    ...
    let filteredArray = this.state.users.filter(
      (user) =>
        user.username !== this.props.loggedInUserUsername &&
        !usernamesOfFollowingArray.includes(user.username)
    );
    ...
    return (
      <div className="suggestions-container">
        <div className="suggestions-top-box">
          <div>
            <img
              className="suggestions-profile-pic"
          ...
          <div className="suggestions-logged-in-user-name-div">
            <p
              className="suggestions-logged-in-user-username"
              onClick={() => navigate("profile-page")}
            >
              {this.props.loggedInUserUsername}
            </p>
            <p className="suggestions-logged-in-user-full-name">
            ...
            <div className="suggestions-user">
              <div>
                <img
                  ...
                  src={this.state.firstProfilePic}
                  alt=""
              ...
              <div>
                <p
                  className="suggestions-user-username"
                  onClick={this.navigateToUserPage.bind(
                    this,
                    this.state.firstId
                  )}
                ...
                <p className="suggestions-user-full-name">
              ...
              <div>
                <p
                  ...
                  onClick={this.followUser.bind(
                    ...
                    this.state.firstUsername,
                    this.state.firstFullName,
                    this.state.firstProfilePic
                  )}
                  style={{ display: this.state.firstDisplay }}
                >
                  Follow
                </p>
              </div>
          ...
          {this.state.secondId !== "" && (
            <div className="suggestions-user">
              <div>
                <img
                  className="suggestions-user-profile-pic"
                  src={this.state.secondProfilePic}
                  alt=""
                  onClick={this.navigateToUserPage.bind(
                    this,
                    this.state.secondId
              ...
              <div>
                <p
                  ...
                  onClick={this.followUser.bind(
                    ...
                    this.state.secondUsername,
                    this.state.secondFullName,
                    this.state.secondProfilePic
                  )}
                  style={{ display: this.state.secondDisplay }}
                >
                  Follow
                </p>
              </div>
          ...
          {this.state.thirdId !== "" && (
            <div className="suggestions-user">
              <div>
                <img
                  className="suggestions-user-profile-pic"
                  src={this.state.thirdProfilePic}
                  alt=""
                  onClick={this.navigateToUserPage.bind(
                    this,
                    this.state.thirdId
              ...
              <div>
                ...
                >
                  {this.state.thirdUsername}
                </p>
                <p className="suggestions-user-full-name">
                  {this.state.thirdFullName}
                </p>
              </div>
              <div>
                <p
                  ...
                  onClick={this.followUser.bind(
                    ...
                    this.state.thirdUsername,
                    this.state.thirdFullName,
                    this.state.thirdProfilePic
                  )}
                  style={{ display: this.state.thirdDisplay }}
                >
                  Follow
                </p>
              </div>

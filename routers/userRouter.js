...
router.put("/messages/:id", (req, res) => {
  User.updateOne(
    {
      _id: req.params.id,
      "messages.recipientUsername": req.body.recipientUsername,
    },
    {
      $push: {
...
router.put("/update_user_info/:id", async (req, res) => {
  ...
  if (usernameInDatabase && loggedInUserUsername !== username)
    return res.status(400).send("Username already exists");
  ...
  User.updateMany(
    {},
    {
      $set: {
        ...
        "messages.$[].messagesBetweenRecipient.$[messagesBR].username":
          req.body.username,
      },
    },
    {
  ...
  User.updateMany(
    {},
    {
      $set: {
        ...
        "messages.$[].messagesBetweenRecipient.$[messagesBR].profilePic":
          req.body.profilePic,
      },
    },
    {
